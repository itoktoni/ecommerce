            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-title="Product">
                        ...
                        <input type="hidden"
                            value="{{ old('temp_name')[$loop->index] ?? $name }}"
                            name="temp_name[]">
                    </td>
                    ...
                    <td data-title="Receive Order" class="text-right col-lg-1">
                        <input type="text" name="temp_receive[]" class="form-control text-right number"
                    ...
                    <td data-title="Barcode" class="text-right col-lg-2">
                        ...
                        <a class="btn btn-danger btn-xs btn-block" target="__blank"
                            href="{{ route('warehouse_stock_print_barcode', ['code' => $item->purchase_detail_barcode]) }}">{{ $item->purchase_detail_barcode }}</a>
                        @endif
                    </td>
                </tr>
                @endforeach
