<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'barcode') ? 'has-error' : ''}}">
        {!! Form::text($form.'barcode', null, ['class' => 'form-control', 'readonly']) !!}
    ...
    <div class="col-md-4 {{ $errors->has($form.'product') ? 'has-error' : ''}}">
        {{ Form::select($form.'product', $product, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'color') ? 'has-error' : ''}}">
        {{ Form::select($form.'color', $color, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
    ...
    <div class="col-md-4 {{ $errors->has($form.'size') ? 'has-error' : ''}}">
        {{ Form::select($form.'size', $size, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
...
<div class="form-group">
   ...
   {!! Form::label('name', 'Location', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has($form.'location') ? 'has-error' : ''}}">
        {{ Form::select($form.'location', $location, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
