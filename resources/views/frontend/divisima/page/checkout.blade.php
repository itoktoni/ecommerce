	...
	<div class="container">
		...
		<div class="row">
			...
			<div id="billing" class="col-lg-8 order-2 order-lg-1">
				...
				<div class="cf-title">Notes To Buyer</div>
				<div class="row address-inputs">
					<div class="col-md-12">
						<input type="text" class="{{ $errors->has('sales_order_rajaongkir_notes') ? 'error' : ''}}" value="{{ $notes ?? null }}" name="sales_order_rajaongkir_notes" placeholder="Notes">
					</div>
				</div>
